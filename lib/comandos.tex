...
%comandos para trabalhar com exibições condicionais booleanas
\newcommand{\true}{1}
\newcommand{\false}{0}
% impressão condicional
% exemplo de uso com 2 parâmetros
% \ift{\coorientadorExiste}{Coorientador fulano de tal}
% exemplo de uso com 3 parâmetros
% \ift[\coorientadorExiste]{Coorientador fulano de tal}{Não existe coorientador}
\newcommand{\ift}[3][]{%
  \ifx\empty#1\empty
    \ifnum#2=\true
      #3
